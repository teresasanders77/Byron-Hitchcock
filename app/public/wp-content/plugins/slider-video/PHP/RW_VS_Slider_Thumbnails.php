				...
				<section id="gallery-con<?php echo $Rich_Web_VSlider_ID; ?>" style="display:none;">
					...
					<section id="gallery-hidden<?php echo $Rich_Web_VSlider_ID; ?>">
						...
						?> 
							<img class="gallery_thumb_img<?php echo $Rich_Web_VSlider_ID; ?>" src="<?php echo $link_vd_sl;?>" onclick="Rich_Web_VSlider_TS_Open_Video<?php echo $Rich_Web_VSlider_ID; ?>('<?php echo $Rich_Web_VSlider_Videos[$i]->Rich_Web_VSldier_Add_Src;?>')"/>
						<?php } ?>
					</section>
