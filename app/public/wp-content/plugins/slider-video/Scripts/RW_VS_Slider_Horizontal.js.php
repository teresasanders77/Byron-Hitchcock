                <script>
					...
					jQuery(".rw_img_sld<?= $Rich_Web_VSlider_ID; ?>").each(function(){
						if( jQuery(this).attr("src") != "" ) {
							array_horizontal<?= $Rich_Web_VSlider_ID; ?>.push(jQuery(this).attr("src"));
						}
					})
					var y_horizontal<?= $Rich_Web_VSlider_ID; ?>=0;
					for(i=0;i<array_horizontal<?= $Rich_Web_VSlider_ID; ?>.length;i++){
						jQuery("<img class='rw_img_sld<?= $Rich_Web_VSlider_ID; ?>' />").attr('src', array_horizontal<?= $Rich_Web_VSlider_ID; ?>[i]).on("load",function(){
					...
					{
						jQuery('.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Overlay').hide(500);
						jQuery('.Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Iframe_Div').hide(500);
						jQuery('#Rich_Web_VS_HPS<?= $Rich_Web_VSlider_ID; ?><?= $Rich_Web_VSlider_ID; ?>_Iframe').attr('src','');
					}
				</script>
				<script>
                     var x = 0;
