<script>					
					function resp()
					{
                        ...
                        jQuery('.next<?php echo $Rich_Web_VSlider_ID; ?>').click(function(){
                        	setTimeout(function(){
                        ...
                        jQuery('.prev<?php echo $Rich_Web_VSlider_ID; ?>').click(function(){
                            setTimeout(function(){
				...
				<script>
					...
					jQuery("img.vccp_img<?php echo $Rich_Web_VSlider_ID; ?>").each(function(){
						if( jQuery(this).attr("src") != "" ) {
							array_vccp<?php echo $Rich_Web_VSlider_ID; ?>.push(jQuery(this).attr("src"));
						}
					})
