...
if ( ! class_exists( 'OriginCode_Gallery_Video' ) ) :
    ...
    final class OriginCode_Gallery_Video {
        ...
        public function add_blocks()
        {
            ...
            global $wpdb;
            $galleriesTable = $wpdb->prefix . 'origincode_videogallery_galleries';
            ...
            wp_localize_script('origincodevdgblock', 'origincodeVdgBlockI10n', array(
                'galleries' => $galleryOptions,
                'galleryMetas' => $galleryMetas,
            ));

            register_block_type('origincode-video-gallery/gallery', array(
                'editor_script' => 'origincodevdgblock',
            ));
        }
        ...
        public function block_categories($categories, $post)
        {
            ...
            return array_merge(
                ...
                array(
                    array(
                        'slug' => 'origincode-video-gallery',
                        'title' => 'OriginCode Video Gallery',
                    ),
                )
            );
        }
        ...
        public function includes() {
			include_once('includes/view/class-install-data.php');
			include_once('includes/view/template-loader.php');
			include_once('includes/view/class-ajax-call.php');
			include_once('includes/view/widgets.php');
			include_once('includes/view/class-widget.php');
			include_once('includes/view/class-shortcode.php');
			include_once('includes/view/call-frontend-scripts.php');
			include_once('includes/admin/admin-page.php');
			include_once('includes/admin/call-admin-assets.php');
			include_once('includes/admin/general-settings.php');
			include_once('includes/admin/video-galleries-page.php');
			include_once('includes/admin/lightbox-settings.php');
